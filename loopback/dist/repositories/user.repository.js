...
let UserRepository = class UserRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, userCredentialsRepositoryGetter, facturaRepositoryGetter) {
...
UserRepository = tslib_1.__decorate([
    tslib_1.__param(0, (0, core_1.inject)(`datasources.${authentication_jwt_1.UserServiceBindings.DATASOURCE_NAME}`)),
