...
> {
  ...
  constructor(
    @inject('datasources.catalogo') dataSource: CatalogoDataSource, @repository.getter('ProductoRepository') protected productoRepositoryGetter: Getter<ProductoRepository>,
  ) {
